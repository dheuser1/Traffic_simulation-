...
int main(int argc, char *argv[])
{
    ...
    sf::RenderWindow window(sf::VideoMode(800, 600), "OBJ File Viewer", sf::Style::Default, contextSettings);
...
void processEvent(sf::Event event,sf::RenderWindow& window)
{
	...
	case sf::Event::MouseMoved:
		if (mousePressed)
		{
			v.mousemove(sf::Mouse::getPosition(window).x,sf::Mouse::getPosition(window).y);
			mouseX = sf::Mouse::getPosition(window).x;
			mouseY = window.getSize().y - sf::Mouse::getPosition(window).y;
