...
public:
	...
	void fill_cars();
	void simulate();
	void breaking(normal_distribution<double> &distribution, default_random_engine &generator);
	void make_data(const int i, const double v, const double p, const double d, const bool b, const int v_size, const string state);
	void to_file();
